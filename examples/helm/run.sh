...
# <<<
# Plots
python model_dkps_analysis-holdout.py --dataset math:subject=algebra                  --n_samples 4
python model_dkps_analysis-holdout.py --dataset math:subject=counting_and_probability --n_samples 4
python model_dkps_analysis-holdout.py --dataset math:subject=geometry                 --n_samples 4
python model_dkps_analysis-holdout.py --dataset math:subject=intermediate_algebra     --n_samples 4
python model_dkps_analysis-holdout.py --dataset math:subject=number_theory            --n_samples 4
python model_dkps_analysis-holdout.py --dataset math:subject=prealgebra               --n_samples 4
python model_dkps_analysis-holdout.py --dataset math:subject=precalculus              --n_samples 4

python model_dkps_analysis-holdout.py --dataset med_qa                                --n_samples 4

python model_dkps_analysis-holdout.py --dataset legalbench:subset=abercrombie                         --n_samples 4
python model_dkps_analysis-holdout.py --dataset legalbench:subset=international_citizenship_questions --n_samples 4
python model_dkps_analysis-holdout.py --dataset legalbench:subset=corporate_lobbying                  --n_samples 4
python model_dkps_analysis-holdout.py --dataset legalbench:subset=function_of_decision_section        --n_samples 4
python model_dkps_analysis-holdout.py --dataset legalbench:subset=proa                                --n_samples 4

python model_dkps_analysis-holdout.py --dataset wmt_14:language_pair=cs-en --n_samples 4 --score_col meteor
python model_dkps_analysis-holdout.py --dataset wmt_14:language_pair=de-en --n_samples 4 --score_col meteor
python model_dkps_analysis-holdout.py --dataset wmt_14:language_pair=fr-en --n_samples 4 --score_col meteor
python model_dkps_analysis-holdout.py --dataset wmt_14:language_pair=hi-en --n_samples 4 --score_col meteor
python model_dkps_analysis-holdout.py --dataset wmt_14:language_pair=ru-en --n_samples 4 --score_col meteor
# >>>
