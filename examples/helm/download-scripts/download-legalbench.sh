...
# download-legalbench.sh

echo "-- download scenario_state.json --"
gcloud storage ls "gs://crfm-helm-public/lite/benchmark_output/runs/*/legalbench*/scenario_state.json" > urls1.txt
...
gcloud storage ls "gs://crfm-helm-public/lite/benchmark_output/runs/*/legalbench*/display_predictions.json" > urls2.txt
