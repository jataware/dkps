...
JUDGES = [('gpt-4o-mini', 'gpt-4o-mini'), ('gpt-5.4-nano', 'gpt-5.4-nano'),
...
fig.text(0.5, 0.955, 'Judge sensitivity: prediction error by construction and extractor',
...
fig.text(0.5, 0.052, 'Rubric writer fixed at gpt-5.4-mini (only cached writer); '
         'all cells embedded with nomic-embed-text-v1.5.',
         ha='center', fontsize=8.2, color='#4a5878')
fig.text(0.5, 0.022, 'Naive trace baseline (no judge): kNN 0.102.',
         ha='center', fontsize=8.2, color='#4a5878')
fig.subplots_adjust(top=0.855, bottom=0.185, left=0.16, right=0.97)
