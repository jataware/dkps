...
gcloud storage ls "gs://crfm-helm-public/lite/benchmark_output/runs/*/wmt_14:*/scenario_state.json" > urls1.txt
...
gcloud storage ls "gs://crfm-helm-public/lite/benchmark_output/runs/*/wmt_14:*/display_predictions.json" > urls2.txt
